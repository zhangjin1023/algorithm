...
/**
 * @description:判断两个单链表是否相交: 如果两个链表相交于某一节点，那么在这个相交节点之后的所有节点都是两个链表所共有的.
...
//        b3.setNext(b4);
     ...
     *                          |---c----
     *           head2  ---b----|
     * 先判断是否相交链表，是的话。必然存在a+c+b = b+c+a.也就是p1指针走完head1链表长度加上head2开头到交点的距离a+c+b
     * 会等于p2指针走完head2链表长度加上head1开头到交点的距离b+c+a.
     *
     * @param head1
     * @param head2
